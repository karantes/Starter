				...
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href='<spring:url value="/funcionalidades.html"/>'>Funcionalidades</a></li>
		...
		<div class="content-body">
			<div class="card">
				...
				<div class="card-content">
					<div class="card-body">
						<form:form modelAttribute="funcionalidade" action="${pageContext.request.contextPath}/funcionalidade-register.html" method="post">
							<div class="row">
								<form:hidden path="id" />
								<div class="col-md-3">
