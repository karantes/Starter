							...
							<tbody>
								<c:forEach items="${funcionalidades }" var="funcionalidade">
									<tr>
										...
										<td style="font-size: 150%;"><a href='<spring:url value="/funcionalidade-update/${funcionalidade.id }.html"/>'> <i
												class="fa fa-edit" title="Editar"></i></a> &nbsp; <a href='<spring:url value="/delete-funcionalidade/${funcionalidade.id }.html"/>'>
