	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-12 mb-2">
				<h3 class="content-header-title mb-0">Funcionalidades</h3>
				<div class="row breadcrumbs-top">
					<div class="breadcrumb-wrapper col-12">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href='<spring:url value="/home"/>'>Home</a></li>
							<li class="breadcrumb-item">Funcionalidades</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="content-body">
			<div class="card">
				<div class="card-header">
					...
					<br> <a href='<spring:url value="/funcionalidade-register"/>' style="width: auto;">
							...
							<tbody>
								<c:forEach items="${funcionalidades }" var="funcionalidade">
									<tr>
										...
										<td>${funcionalidade.name }</td>
										<td>${funcionalidade.value }</td>
										<td>${funcionalidade.method }</td>
										<td style="font-size: 150%;"><a href='<spring:url value="/funcionalidade-update/${funcionalidade.id }"/>'> <i
												class="fa fa-edit" title="Editar"></i></a> &nbsp; <a href='<spring:url value="/delete-funcionalidade/${funcionalidade.id }"/>'>
