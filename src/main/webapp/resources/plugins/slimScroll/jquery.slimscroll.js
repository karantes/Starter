				...
				slimScroll : function(options) {
					...
					this
							.each(function() {
								...
								o.height = (o.height == 'auto') ? me.parent()
										.height() : o.height;
										...
										.css(
												{
													...
													position : 'absolute',
													top : 0,
													display : (o.alwaysVisible && o.railVisible) ? 'block'
															: 'none',
								...
								if (o.start === 'bottom') {
									...
									scrollContent($(o.start).position().top,
											null, true);
								...
								function scrollContent(y, isWheel, isJump) {
									...
									percentScroll = parseInt(bar.css('top'))
											/ (me.outerHeight() - bar
													.outerHeight());
									delta = percentScroll
